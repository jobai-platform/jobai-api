...
class FakeBillingGateway(BillingGateway):
    async def create_checkout_session(self, *, email: str, user_id: UUID, plan: str, success_url: str, cancel_url: str) -> str:
    ...
    async def create_subscription(self, *, customer_id: str, stripe_price_id: str, user_id: UUID, plan: Plan) -> str:
